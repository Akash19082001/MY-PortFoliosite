...
const Workdemo = ({ year, title, duration, details }) => {
  return (
    <ol className="flex flex-col md:flex-row relative border-animate border-l border-stone-200">
      <li className="mb-10 ml-3">
        <div id="career" className="absolute w-3 h-3 bg-stone-200 rounded-full mt-1.5 -left-1.5 border-white"/>
